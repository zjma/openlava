...
# lib
install -m 755 $RPM_BUILD_DIR/%{name}-%{version}/lsf/lib/.libs/liblsf.a  $RPM_BUILD_ROOT%{_openlavatop}/lib
install -m 755 $RPM_BUILD_DIR/%{name}-%{version}/lsbatch/lib/.libs/liblsbatch.a  $RPM_BUILD_ROOT%{_openlavatop}/lib
...
- openlava configuration files and use the output variables to make
